...
{
	player createDiaryRecord ["Diary", [localize "STR_Mission", format [format ["%1 <marker name='mrkObj'>%2</marker> %3", localize "STR_Mission1", localize "STR_Mission2", localize "STR_Mission4"], timeLimit/60, 3, 6]]];
};