...
_allRoads = [objPos select 0, objPos select 1] nearRoads 1000; //1.13tf7 вмсето 2500 стало 1000
_truckOnRoad=false;
_tankOnRoad=false;
...
{
	_pos = [objPos, minDist, minDist * 1.25, 6, 0, 0.5, 0, [], [markerPos "mrkDefaultPos", markerPos "mrkDefaultPos"]] call bis_fnc_findSafePos;
};
